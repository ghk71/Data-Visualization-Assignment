...
function update(value) {
  ...
  d3.selectAll(".Firecircle")
      .attr("fill", fireColorMatch);

  d3.selectAll(".Hospitalcircle")
      .attr("fill", hospitalColorMatch);

  d3.selectAll(".mypath")
      .style("stroke", strokeMatch);

}

function strokeMatch(data, value) {
  if(data.distance >= inputValue) return "black";
  else return "none";
}

function hospitalColorMatch(data, value) {
  if(data.distance >= inputValue) return "yellow";
  else return "none";
}
